...
(function(Object, descriptor) {
	...
	// object.watch
	if (
		"replace Mozilla's own prototype.watch with this custom one - for consistency - hope it doesn't break anything !!! :-0 " ||
		!prototype.watch
	) {
		descriptor.value = function(property, handler) {
			...
			if (
				descriptor.configurable && // can't watch constants
				descriptor.writable !== false
			) {
				// don't watch readonly
